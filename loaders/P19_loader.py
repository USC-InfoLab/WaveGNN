...
class P19Loader(torch.utils.data.Dataset):
    def __init__(
        self, data_dict, window_size, irregularity=False, irregularity_rate=0.0
    ):
        """
        Args:
    ...
    def __getitem__(self, idx):
        ...
        # Mask generation with consideration for irregularity and length
