...
class P12Loader(torch.utils.data.Dataset):
    def __init__(
        self,
        data_dict,
        window_size,
    ...
    def __getitem__(self, idx):
        ...
        total_entries = self.w_len * self.n_sensors
        total_drops = int(self.irregularity_rate * total_entries)
